...
class Cell extends Component {
  ...
  onChange = (e) => {
    ...
    this.display = this.determineDisplay(
      { x: this.props.column, y: this.props.row }, e.target.value)
  }
  ...
  clicked = () => {
    ...
    this.timer = setTimeout(() => {
      if (!this.prevent) {
        ...
        //Set editing to true if you want to edit the cell content on single click
        this.setState({ editing: false, selected: true })
      }
      this.prevent = false
    }, this.delay)
  }
